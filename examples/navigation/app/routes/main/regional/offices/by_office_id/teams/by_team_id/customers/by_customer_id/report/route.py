...
from app.presentation import owned_customer, regional_office, regional_team, root_path


def create_regional_customer_report(request: Request) -> CustomerReportKit:
    ...
    if office is not None and team is not None and customer is not None:
...
Route = route_mount(
    create=create_regional_customer_report,
